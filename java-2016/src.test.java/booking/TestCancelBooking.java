...
/**
 * Test for cancel booking. The test assert if you can cancel a booking based on a:
...
public class TestCancelBooking {
	...
	public void init() {
		 ...
		 * When you cancel the booking, you will erase this arrayList.
		 */
	...
	public void test() {
		...
		if (cancelBooking()) {
			for (int i = 0; i < bookingView.size(); i++) {
				assertNull(bookingView.get(i));
			}
		}
