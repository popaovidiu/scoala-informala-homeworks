...
public class Punto extends Fiat {
	...
	private final static float fuelTankSize = (float) 47.66;

	public Punto(float totalFuelAmount, String chasseNumber) {
	...
	private float getAverageFuelConsumptionPerGear() {
		double consumtionFactorPerGear = 1.25; // Different for every type of
												// car
		if (carStart == true) {
			switch (gear) {
			case 1:
