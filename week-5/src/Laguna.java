...
public class Laguna extends Renault {

	private final static float fuelTankSize = (float) 44.15;
	


	public Laguna(float totalFuelAmount, String chasseNumber) {
	...
	private float getAverageFuelConsumptionPerGear() {
		double consumtionFactorPerGear = 0.75; // Different for every type of
												// car
		if (carStart == true) {
			switch (gear) {
			case 1:
	...
	public void start() {
		System.out.println("");
		System.out.println("-------   Renault Laguna   -------");
