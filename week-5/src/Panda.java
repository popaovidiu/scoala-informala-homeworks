...
public class Panda extends Fiat {
	...
	private final static float fuelTankSize = (float) 42.15;

	public Panda(float totalFuelAmount, String chasseNumber) {
	...
	private float getAverageFuelConsumptionPerGear() {
		double consumtionFactorPerGear = 1.13; // Different for every type of
												// car
		if (carStart == true) {
			switch (gear) {
			case 1:
